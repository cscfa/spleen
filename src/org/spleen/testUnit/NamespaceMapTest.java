...
public class NamespaceMapTest {
	...
	public void testNamespaceMap() {
		...
		NamespaceMap mainNM = new NamespaceMap(sc);
		
		assertNotNull(mainNM);
	}
	...
	public void testAdd() {
		...
		SpleenConfigurator sc = new SpleenConfigurator();
		NamespaceMap nm = new NamespaceMap(sc);
	...
	public void testRemoveFirst() {
		...
		assertTrue(nm.getCacheObjectOrder().getFirst().toString().equals(("third").toString()));
